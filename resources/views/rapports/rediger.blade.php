...
<div class="card card-primary " style="width: 100%">
    <div class="card-header">
        <h3 class="card-title">
         ...
         <?php// if (isset($intervention->Commune)) echo $intervention->Numero_Intervention?>
        </h3>
    </div>
    <div class="card-body">
        <h4>DETAIL</h4>
                                ...
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        ...
                                        foreach(//$engins as $e){?>
                                            <li class="nav-item">
                                                <a class="nav-link 
                                                <?php //if ($drp== 0)  echo 'active' ?>
                                                 " href="#
                                                 <?php// if (isset($e->Nom_Engin))  echo $e->Nom_Engin?>" data-toggle="tab">
                                                 <?php// if (isset($e->Nom_Engin))  echo $e->Nom_Engin?>
                                                </a>
                                            </li>
                                            <?php// $drp++;  } ?>
                                    </ul>
